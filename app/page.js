...
// ===== CATÁLOGO FERRACINI PIRACICABA =====
const PRODUCTS = [
  // ===== ESPORTE FINO (casual elegante) =====
  { id: 1, name: 'Fluence', desc: 'Esporte fino premium, sola contrastante bicolor', price: 399.90, image: IMAGES.img01, category: 'esporte-fino', range: '380-430', details: ['Couro legítimo', 'Sola anatômica', 'Palmilha em couro', 'Bico arredondado'] },
  { id: 2, name: 'Kingston', desc: 'Esporte fino marrom, cap toe, sola branca', price: 369.90, image: IMAGES.img02, category: 'esporte-fino', range: 'ate-380', details: ['Couro marrom premium', 'Detalhe perfurado', 'Cadarço encerado', 'Sola contrastante'] },
  { id: 3, name: 'Wembley', desc: 'Esporte fino marrom escuro, sola tratorada', price: 419.90, image: IMAGES.img03, category: 'esporte-fino', range: '380-430', details: ['Couro vintage', 'Sola tratorada', 'Forro em couro', 'Bico arredondado'] },
  
  // ===== SOCIAL =====
  { id: 8, name: 'Ambience', desc: 'Social premium preto, costura à mão', price: 429.90, image: IMAGES.img08, category: 'social', range: '380-430', details: ['Couro vitelo', 'Bico fino', 'Sola de couro', 'Acabamento à mão'] },
  { id: 9, name: 'London', desc: 'Social slip-on preto, sem cadarço, executivo', price: 339.90, image: IMAGES.img09, category: 'social', range: 'ate-380', details: ['Slip-on prático', 'Couro liso', 'Forro respirável', 'Bico alongado'] },
  { id: 10, name: 'Bentley', desc: 'Social caramelo, brogue, detalhes perfurados', price: 449.90, image: IMAGES.img10, category: 'social', range: 'acima-430', details: ['Estilo brogue', 'Couro caramelo', 'Detalhes perfurados', 'Sola robusta'] },
  
  // ===== MOCASSIM & DOCK SIDE =====
  { id: 11, name: 'Buzios', desc: 'Dock Side mocassim cinza, couro pull up', price: 419.90, image: IMAGES.img11, category: 'mocassim', range: '380-430', details: ['Estilo Dock Side', 'Couro pull up', 'Cadarço náutico', 'Sola de borracha'] },
  { id: 12, name: 'Prisma', desc: 'Mocassim preto camurça, sem cadarço, casual chique', price: 389.90, image: IMAGES.img12, category: 'mocassim', range: '380-430', details: ['Camurça preta', 'Slip-on', 'Sola esportiva', 'Forro em couro'] },
  { id: 13, name: 'Malta', desc: 'Mocassim bege/areia, camurça leve, super conforto', price: 399.90, image: IMAGES.img13, category: 'mocassim', range: '380-430', details: ['Camurça nobre', 'Modelagem confortável', 'Sola anatômica', 'Cor versátil'] },
  
  // ===== SAPATÊNIS =====
  { id: 4, name: 'Star', desc: 'Sapatênis preto, sola contrastante, casual moderno', price: 359.90, image: IMAGES.img04, category: 'sapatenis', range: 'ate-380', details: ['Couro liso', 'Cadarço plano', 'Sola flexível', 'Palmilha confortável'] },
  { id: 14, name: 'Vox Náutico', desc: 'Sapatênis náutico cinza, ilhoses laterais', price: 359.90, image: IMAGES.img14, category: 'sapatenis', range: 'ate-380', details: ['Estilo náutico', 'Nobuck premium', 'Ilhoses metálicos', 'Sola branca'] },
  { id: 15, name: 'New Blady', desc: 'Sapatênis grafite, design clean, sem cadarço aparente', price: 369.90, image: IMAGES.img15, category: 'sapatenis', range: 'ate-380', details: ['Couro grafite', 'Zíper lateral', 'Modelagem moderna', 'Sola robusta'] },
  { id: 16, name: 'Vox Azul Marinho', desc: 'Sapatênis premium azul, nobuck refinado', price: 369.90, image: IMAGES.img16, category: 'sapatenis', range: 'ate-380', details: ['Nobuck azul marinho', 'Costura aparente', 'Cadarço encerado', 'Sola contrastante'] },
  
  // ===== SNEAKERS =====
  { id: 17, name: 'Energy Knit', desc: 'Sneaker knit grafite, tecido respirável, ultra leve', price: 399.90, image: IMAGES.img17, category: 'sneaker', range: '380-430', details: ['Tecido knit', 'Sem cadarço', 'Ultra leve', 'Sola tratorada'] },
  { id: 18, name: 'Still', desc: 'Sneaker cinza camurça, sola dentada, urbano', price: 439.90, image: IMAGES.img18, category: 'sneaker', range: 'acima-430', details: ['Camurça premium', 'Sola dentada', 'Design oversize', 'Bico arredondado'] },
  { id: 19, name: 'Mid', desc: 'Sneaker esportivo azul/preto, performance', price: 439.90, image: IMAGES.img19, category: 'sneaker', range: 'acima-430', details: ['Material misto', 'Tecnologia esportiva', 'Solado robusto', 'Visual athletic'] },
  
  // ===== BOTAS =====
  { id: 5, name: 'Cross', desc: 'Bota Chelsea cinza camurça, sola tratorada', price: 429.90, image: IMAGES.img05, category: 'bota', range: '380-430', details: ['Estilo Chelsea', 'Camurça premium', 'Elástico lateral', 'Sola tratorada'] },
  { id: 6, name: 'Columbia', desc: 'Bota cano médio marrom, cadarço, militar moderno', price: 469.90, image: IMAGES.img06, category: 'bota', range: 'acima-430', details: ['Couro envelhecido', 'Cadarço resistente', 'Zíper lateral', 'Sola robusta'] },
  { id: 7, name: 'Firenze', desc: 'Bota cano médio caramelo, couro premium, sola clara', price: 429.90, image: IMAGES.img07, category: 'bota', range: '380-430', details: ['Couro caramelo', 'Acabamento envelhecido', 'Zíper lateral', 'Sola contrastante'] },
];

const CATEGORIES_MAP = {
  social: { label: 'Social', desc: 'Reunião e escritório', icon: '👔' },
  'esporte-fino': { label: 'Esporte Fino', desc: 'Elegante e confortável', icon: '✦' },
...
function ResultScreen({ filters, onBack, onRestart, mode = 'curadoria', onSelectProduct }) {
  const matches = useMemo(() => {
    if (mode === 'urgente') {
      return PRODUCTS.filter(p => p.price !== null && p.price <= 380).slice(0, 4);
    }
    if (mode === 'browse') {
      return PRODUCTS;
    }
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', animation: 'fadeUp 0.4s ease-out' }} key={screen}>
        ...
        {screen === 'step1' && (
          <QuizScreen
            ...
            emojiMap={{ 'ate-380': '♥', '380-430': '✦', 'acima-430': '★' }}
          />
        )}
        {screen === 'result' && (
      ...
      <ProductDetailModal
        ...
        onWhatsApp={(p) => {
          const intro = 'Oi! Vim pelo app da Ferracini Piracicaba 🌟 Vi o catálogo e me interessei.';
